    ...
    for section in content:
        if section['type'] == 'heading':
            ...
            code_style = ParagraphStyle('Code',
                                      ...
                                      leftIndent=20,
                                      spaceAfter=12)
            story.append(Paragraph(f"<font name='Courier'>{section['text']}</font>", code_style))
...
def generate_async_python_pdf(folder_path):
    ...
    content = [
        {
            'type': 'heading',
            'text': 'Introduction to Async Programming'
        },
        {
            'type': 'paragraph',
        ...
        {
            'type': 'heading',
            'text': 'Best Practices for Async in Python'
        },
        {
            'type': 'paragraph',
...
def generate_python_performance_pdf(folder_path):
    ...
    content = [
        {
            'type': 'heading',
            'text': 'Understanding Python Performance'
        },
        {
            'type': 'paragraph',
        ...
        {
            'type': 'code',
            'text': 'python -m cProfile -s cumulative your_script.py'
        },
        {
            'type': 'heading',
            'text': 'Data Structure Optimization'
        },
        {
            'type': 'paragraph',
        ...
        {
            'type': 'heading',
            'text': 'Async for I/O-Bound Operations'
        },
        {
            'type': 'paragraph',
...
def generate_web_scraping_pdf(folder_path):
    ...
    content = [
        ...
        {
            'type': 'heading',
            'text': 'Async Web Scraping Best Practices'
        },
        {
            'type': 'paragraph',
        ...
        {
            'type': 'heading',
            'text': 'Scaling Web Scraping Operations'
        },
        {
            'type': 'paragraph',
...
def generate_api_design_pdf(folder_path):
    ...
    content = [
        {
            'type': 'heading',
            'text': 'Principles of Good API Design'
        },
        {
            'type': 'paragraph',
...
def generate_microservices_pdf(folder_path):
    ...
    content = [
        ...
        {
            'type': 'heading',
            'text': 'Service Design Best Practices'
        },
        {
            'type': 'paragraph',
        ...
        {
            'type': 'heading',
            'text': 'Async Processing in Microservices'
        },
        {
            'type': 'paragraph',
