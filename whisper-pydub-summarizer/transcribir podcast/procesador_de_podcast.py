...
def main():
    ...
    if not api_key:
        ...
        print("Either update OPENAI_API_KEY in the script or set the OPENAI_API_KEY environment variable.")
        return
    ...
    try:
        ...
        with open(output_file, "w") as f:
            ...
            f.write("=" * 50 + "\n\n")
            for idx, action_items in enumerate(all_action_items):
                f.write(f"Segment {idx + 1} (minutes {idx * SEGMENT_LENGTH_MINUTES}-{(idx + 1) * SEGMENT_LENGTH_MINUTES}):\n")
